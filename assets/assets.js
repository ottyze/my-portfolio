...
import prof_pic from './prof-pic.png'
...
export const infoList = [
    { icon: assets.code_icon, iconDark: assets.code_icon_dark, title: 'Languages', description: 'JavaScript, React Js, Next Js, Python, Node Js' },

  ...
  return (
    ...
    id={'work'} className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
        I have developed a variety of scalable and user-centric web applications, including e-commerce platforms, movie databases, weather apps, and payment integrations. Using modern frameworks and cloud technologies, my projects prioritize performance, security, and seamless functionality, delivering intuitive and efficient digital experiences.
      </motion.p>
